...
Blockly.PHP.lists_setIndex = function (a) {
    ...
    switch (c) {
        ...
        case "RANDOM":
            ...
            c.match(/^\$\w+$/) ? a = "" : (a = Blockly.PHP.variableDB_.getDistinctName("tmp_list", Blockly.VARIABLE_CATEGORY_NAME), e = a + " = &" + c + ";\n", c = a, a = e);
            e = Blockly.PHP.variableDB_.getDistinctName("tmp_x", Blockly.VARIABLE_CATEGORY_NAME);
            a += e + " = rand(0, count(" +
                c + ")-1);\n";
...
Blockly.PHP.controls_repeat_ext = function (a) {
    ...
    a = "";
    var d = Blockly.PHP.variableDB_.getDistinctName("count", Blockly.VARIABLE_CATEGORY_NAME), e = b;
    b.match(/^\w+$/) || Blockly.isNumber(b) || (e = Blockly.PHP.variableDB_.getDistinctName("repeat_end", Blockly.VARIABLE_CATEGORY_NAME), a += e + " = " + b + ";\n");
    return a + ("for (" +
        d + " = 0; " + d + " < " + e + "; " + d + "++) {\n" + c + "}\n")
};
...
Blockly.PHP.controls_for = function (a) {
    var b = Blockly.PHP.variableDB_.getName(a.getFieldValue("VAR"), Blockly.VARIABLE_CATEGORY_NAME),
    ...
    if (Blockly.isNumber(c) && Blockly.isNumber(d) && Blockly.isNumber(e)) {
        ...
        b = Math.abs(Number(e));
        a = (1 == b ? a + (g ? "++" : "--") : a + ((g ? " += " : " -= ") + b)) + (") {\n" + f + "}\n")
    } else a = "", g = c, c.match(/^\w+$/) || Blockly.isNumber(c) || (g = Blockly.PHP.variableDB_.getDistinctName(b + "_start", Blockly.VARIABLE_CATEGORY_NAME), a += g + " = " + c + ";\n"), c = d, d.match(/^\w+$/) || Blockly.isNumber(d) || (c = Blockly.PHP.variableDB_.getDistinctName(b + "_end", Blockly.VARIABLE_CATEGORY_NAME), a += c + " = " + d + ";\n"), d = Blockly.PHP.variableDB_.getDistinctName(b + "_inc", Blockly.VARIABLE_CATEGORY_NAME),
...
Blockly.PHP.math_change = function (a) {
    ...
    return Blockly.PHP.variableDB_.getName(a.getFieldValue("VAR"), Blockly.VARIABLE_CATEGORY_NAME) + " += " + b + ";\n"
};
...
Blockly.PHP.procedures_defreturn = function (a) {
    for (var b = [], c, d = a.workspace, e = Blockly.Variables.allUsedVarModels(d) || [], f = 0; c = e[f]; f++) c = c.name, -1 == a.arguments_.indexOf(c) && b.push(Blockly.PHP.variableDB_.getName(c, Blockly.VARIABLE_CATEGORY_NAME));
    ...
    var l = [];
    for (f = 0; f < a.arguments_.length; f++) l[f] = Blockly.PHP.variableDB_.getName(a.arguments_[f], Blockly.VARIABLE_CATEGORY_NAME);
    b = "function " + d + "(" + l.join(", ") + ") {\n" + b + e + c + g + k + h + "}";
...
Blockly.PHP.procedures_callreturn = function (a) {
    for (var b = Blockly.PHP.variableDB_.getName(a.getFieldValue("NAME"), Blockly.PROCEDURE_CATEGORY_NAME), c = [], d = 0; d < a.arguments_.length; d++) c[d] = Blockly.PHP.valueToCode(a, "ARG" + d, Blockly.PHP.ORDER_COMMA) || "null";
...
Blockly.PHP.text_join = function (a) {
    ...
    for (var c = 0; c < a.itemCount_; c++) b[c] = Blockly.PHP.valueToCode(a,
        "ADD" + c, Blockly.PHP.ORDER_COMMA) || "''";
...
Blockly.PHP.variables_get = function (a) {
    return [Blockly.PHP.variableDB_.getName(a.getFieldValue("VAR"), Blockly.VARIABLE_CATEGORY_NAME), Blockly.PHP.ORDER_ATOMIC]
};
