...
function test_block_base_constructor() {
    ...
    try {
        ...
        checkExactEventValues(event, {
            'blockId': '1', 'workspaceId': workspace.id,
...
function test_varCreate_toJson() {
    ...
    try {
        ...
        var expectedJson = ({
            type: "var_create", varId: "id1", varType: "type1",
            varName: "name1"
        });
...
function test_varDelete_toJson() {
    ...
    var json = event.toJson();
    var expectedJson = ({
        type: "var_delete", varId: "id1", varType: "type1",
        varName: "name1"
    });
...
function test_varRename_toJson() {
    ...
    var json = event.toJson();
    var expectedJson = ({
        type: "var_rename", varId: "id1", oldName: "name1",
        newName: "name2"
    });
