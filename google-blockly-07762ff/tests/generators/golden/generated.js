...
var unittestResults, test_name, naked, proc_x, proc_y, func_x, func_y, func_a, n, ok, log, count, varToChange, rand,
    item, text, number_of_calls, list, proc_z, func_z, x, proc_w, func_c, if2, i, loglist, changing_list, list_copy;
...
function test_operations_on_list() {
    assertEquals([3, 4, 5].reduce(function (x, y) {
        return x + y;
    }), 12, 'sum');
