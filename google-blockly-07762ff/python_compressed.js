...
Blockly.Python.send = function (a) {
    var b = a.getFieldValue("button");
    a = a.getFieldValue("NAME");
    return "    send(".concat(b, ",", a, ")").concat("\n")
};
Blockly.Python.start = function (a) {
...
Blockly.Python.end = function (a) {
    return "except KeyboardInterrupt:\n    send('RELEASE')\n    ser.close()"
};
Blockly.Python.firsttime = function (a) {
    var b = a.getFieldValue("times");
    a = Blockly.Python.statementToCode(a, "blocksinside");
    return "if count == ".concat(b, ":\n", a)
};
    ...
    if (Blockly.isNumber(c) && Blockly.isNumber(d) &&
        ...
        var l = function (a, c) {
            if (Blockly.isNumber(a)) a = Number(a); else if (a.match(/^\w+$/)) a = "float(" + a + ")"; else {
                var d = Blockly.Python.variableDB_.getDistinctName(b + c, Blockly.VARIABLE_CATEGORY_NAME);
                h += d + " = float(" + a + ")\n";
                a = d
            }
            return a
...
Blockly.Python.procedures_defreturn = function (a) {
    ...
    var h = Blockly.Python.statementToCode(a, "STACK"), g = Blockly.Python.valueToCode(a,
        "RETURN", Blockly.Python.ORDER_NONE) || "", k = "";
    h && g && (k = e);
